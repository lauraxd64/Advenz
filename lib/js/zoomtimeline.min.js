...
(function(a){a.fn.prependOnce=function(b,c){var f=a(this);if("undefined"==typeof c){var h=/class="(.*?)"/.exec(b);"undefined"!=typeof h[1]&&(c="."+h[1])}return 1>f.children(c).length?(f.prepend(b),!0):!1};a.fn.appendOnce=function(b,c){var f=a(this);if("undefined"==typeof c){var h=/class="(.*?)"/.exec(b);"undefined"!=typeof h[1]&&(c="."+h[1])}return 1>f.children(c).length?(f.append(b),!0):!1};a.fn.zoomtimeline=function(b){if("undefined"==typeof b&&"undefined"!=typeof a(this).attr("data-options")&&
    ...
    refresh_tab_height:"0",startItem:"default",outer_menu:null,color_highlight:"rgba(167, 220, 220, 1)",mode_3dslider_item_width:"250",mode_3dslider_item_height:"220",mode_3dslider_mode:"normal",settings_isotope_settings:{getSortData:{number:function(b){return parseInt(a(b).attr("data-sort"),10)}},itemSelector:".isotope-item",sortBy:"number",layoutMode:"packery",masonry:{columnWidth:".grid-sizer"},packery:{columnWidth:1}}},b);this.each(function(){function c(b,l){G=a(window).scrollTop();H=a(window).height();
    ...
    "mode-3dslider"==b.settings_mode&&(d.append('<div class="yearlist-con"><div class="yearlist-container"><div class="yearlist-container-inner"><div class="yearlist-line"></div><div class="yearlist"></div></div></div></div>'),d.append('<div class="details-container"><div class="clear"></div></div>'),n=d.children(".details-container"),y=d.find(".yearlist").eq(0));u();"default"==b.startItem&&(b.startItem=0);a(window).on("resize",K);K();m=200;
    /*Funcion validador dispositivo*/
    aquisi = '';if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {console.log('estamos desde un movil o tablet');aquisi = '';}else{console.log('estamos desde un pc escritorio');aquisi = d.on("click",E);}
    "mode-3dslider"==b.settings_mode&&(m=500,z(b.startItem),aquisi,d.on("mouseover",E),d.on("mouseleave",E),a(document).on("keydown",M),is_touch_device()&&N());
    /*-----------------------------*/
    setTimeout(function(){d.addClass("ztm-ready")},m);d.addClass("inited")}}function u(){var c=0;w&&(w.children(".ztm-item:not(.inited)").each(function(){var l=a(this);if("mode-3dslider"==b.settings_mode){d.find(".yearlist").append('<div class="year"><div class="the-year">'+l.find(".hex-desc").html()+"</div><figure></figure></div>");var p=l.find(".ztm-content").html(),e=/<h3.*?class="the-heading".*?>(.*?)<\/h3>/g.exec(p),
...
(p+=l.children(".extrahtml").eq(0).html());p+="</div>";d.find(".details-container").append(p)}l.addClass("inited");c++}),w.children(".ztm-item").each(function(){a(this)}))}function M(b){a(this);F&&(37==b.keyCode&&A(),39==b.keyCode&&B())}function E(b){var c=a(this);"mouseover"==b.type&&(F=!0);"mouseleave"==b.type&&(F=!1);if("click"==b.type&&(b=b.clientX-d.offset().left,d.offset(),c.hasClass("zoomtimeline")&&(b<r/2-k/2&&A(),b>r/2+k/2&&B()),c.hasClass("year")&&(b=c.parent().children().index(c),z(b)),
    ...
    L()}function L(b){var c={calculate_year_position:!0};b&&a.extend(c,b)}function N(){d.addClass("swipe-enabled");var b=0,a=0,c=!1,e=d,f=null;e.on("touchstart", '.detail-image', function(a){a&&a.originalEvent&&(b=a.originalEvent.touches[0].pageX);f=d;c=!0;d.addClass("closedhand");console.info("TRIGGERED TOUCH START")});e.on("swipeleft",function(a){console.info("SWIPE LEFT")});e.on("touchmove", '.detail-image', function(b){0!=c&&(a=b.originalEvent.touches[0].pageX)});e.on("touchend", '.detail-image', function(e){c=!1;f==d&&(a-b<-(r/5)&&B(),a-b>r/5&&A());
...
function add_query_arg(a,b,c){b=encodeURIComponent(b);c=encodeURIComponent(c);var f=b+"="+c;a=a.replace(new RegExp("(&|\\?)"+b+"=[^&]*"),"$1"+f);-1<a.indexOf(b+"=")||(f=-1<a.indexOf("?")?"&"+f:"?"+f,a+=f);"NaN"==c&&(a=a.replace(new RegExp("[?|&]"+b+"="+c),""));return a}function is_touch_device(){return!!("ontouchstart"in window)}
jQuery(document).ready(function(a){dzsztm_init(".zoomtimeline.auto-init",{init_each:!0})});